        ...
        <div class="tab-pane active" id="tab_1">
          ...
          <div class="col-md-6">
            <div class="form-group col-sm-12">
                ...
                {!! Form::text('faktor_resiko',isset($dt) ? $dt->faktor_resiko : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('operasi', 'Operasi:') !!}
                {!! Form::text('operasi',isset($dt) ? $dt->operasi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('emergensi', 'Emergensi:') !!}
                {!! Form::text('emergensi',isset($dt) ? $dt->emergensi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('tgl_operasi', 'Tanggal Operasi:') !!}
                {!! Form::text('tgl_operasi',isset($dt) ? $dt->tgl_operasi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('dr_operator', 'Dokter Operator:') !!}
                {!! Form::text('dr_operator',isset($dt) ? $dt->dr_operator : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('tindakan_operasi', 'Tindakan Operasi:') !!}
                {!! Form::text('tindakan_operasi',isset($dt) ? $dt->tindakan_operasi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('jns_operasi', 'Jenis Operasi:') !!}
                {!! Form::text('jns_operasi',isset($dt) ? $dt->jns_operasi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('anastesi', 'Anastesi Umum:') !!}
                {!! Form::text('anastesi',isset($dt) ? $dt->anastesi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('kamar_operasi', 'Kamar Operasi:') !!}
                {!! Form::text('kamar_operasi',isset($dt) ? $dt->kamar_operasi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('ronde_ke', 'Ronde Ke:') !!}
                {!! Form::text('ronde_ke',isset($dt) ? $dt->ronde_ke : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('lama_operasi', 'Lama Operasi:') !!}
                {!! Form::text('lama_operasi',isset($dt) ? $dt->lama_operasi : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
            <div class="form-group col-sm-12">
                {!! Form::label('asa_score', 'ASA Score:') !!}
                {!! Form::text('asa_score',isset($dt) ? $dt->asa_score : null, ['class' => 'form-control','readonly'=>'readonly']) !!}
            </div>
          </div><!-- end col 2 -->
          </div>
        </div>
