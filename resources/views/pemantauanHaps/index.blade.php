...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">PEMANTAUAN HAP PASIEN BED REST</h1>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="button" class="btn btn-default" value="Cari" url="/hap/cari-pasien" id="CariPasien">

              </div>
            </div>

            <div id="hasiPencarianPasien">
              @include('pemantauanHaps.data_pasien')
            </div>
          </div>
              ...
              <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <input type="button" class="btn btn-default" value="Cari" url="/hap/cari-data-observe" id="cariDataObs">
                    </div>
                  </div>
                </div>
              </div>
              <div id="tbData">
                @include('pemantauanHaps.table')
              </div>
            </div>
        </div>
    </div>
