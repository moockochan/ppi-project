    ...
    <?php
      if(!empty($tbindex)){
        ...
        foreach ($tbindex as $key => $value) {
          ...
          $no++;
          ?>
          {!! Form::open(['route' => ['pemantauanIsks.destroy', $id], 'method' => 'delete']) !!}
          <div class='btn-group'>
              <a href="{{ route('pemantauanIsks.show', $id) }}" class='btn btn-default btn-xs'>
                  <i class="glyphicon glyphicon-eye-open"></i>
              </a>
              <a href="{{ route('pemantauanIsks.edit', $id) }}" class='btn btn-default btn-xs'>
