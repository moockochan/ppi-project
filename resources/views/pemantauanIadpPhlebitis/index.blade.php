...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">PEMANTAUAN IADP-PHLEBITIS</h1>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="button" class="btn btn-default" value="Cari" url="/phlebitis/cari-pasien" id="CariPasien">

              </div>
            </div>

            <div id="hasiPencarianPasien">
              @include('pemantauanIadpPhlebitis.data_pasien')
            </div>
          </div>
              ...
              <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <input type="button" class="btn btn-default" value="Cari" url="/phlebitis/cari-data-observe" id="cariDataObs">
                    </div>
                  </div>
                </div>
              </div>
              <div id="tbData">
                @include('pemantauanIadpPhlebitis.table')
              </div>
            </div>
        </div>
    </div>
